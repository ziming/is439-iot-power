        ...
        (function (Utils) {
            ...
            var Map = (function () {
                ...
                Map.prototype.forEach = function (callbackFn, thisArg) {
                    var _this = this;
                    if (this._es6Map != null) {
                        var callbackWrapper = function (value, key) {
        ...
        (function (Utils) {
            ...
            var Set = (function () {
                ...
                Set.prototype.forEach = function (callback, thisArg) {
                    var _this = this;
                    if (this._es6Set != null) {
                        var callbackWrapper = function (value, value2) {
                            return callback.call(thisArg, value, value2, _this);
                        };
    ...
    (function (Plottable) {
        ...
        (function (RenderController) {
            ...
            function flush() {
                if (_animationRequested) {
                    // Layout
                    _componentsNeedingComputeLayout.forEach(function (component) {
                        return component.computeLayout();
                    });
    ...
    (function (Plottable) {
        ...
        (function (Formatters) {
            ...
            function siSuffix(numberOfSignificantFigures) {
                if (numberOfSignificantFigures === void 0) {
                    numberOfSignificantFigures = 3;
                }
                verifyPrecision(numberOfSignificantFigures);
                return function (d) {
                    return d3.format("." + numberOfSignificantFigures + "s")(d);
                };
            }
        ...
        (function (SymbolFactories) {
            function circle() {
                return function (symbolSize) {
                    return d3.svg.symbol().type("circle").size(Math.PI * Math.pow(symbolSize / 2, 2))(null);
                };
            }
            ...
            function square() {
                return function (symbolSize) {
                    return d3.svg.symbol().type("square").size(Math.pow(symbolSize, 2))(null);
                };
            }
            ...
            function cross() {
                return function (symbolSize) {
                    return d3.svg.symbol().type("cross").size((5 / 9) * Math.pow(symbolSize, 2))(null);
                };
            }
            ...
            function diamond() {
                return function (symbolSize) {
                    return d3.svg.symbol().type("diamond").size(Math.tan(Math.PI / 6) * Math.pow(symbolSize, 2) / 2)(null);
                };
            }
            ...
            function triangleUp() {
                return function (symbolSize) {
                    return d3.svg.symbol().type("triangle-up").size(Math.sqrt(3) * Math.pow(symbolSize / 2, 2))(null);
                };
            }
            ...
            function triangleDown() {
                return function (symbolSize) {
                    return d3.svg.symbol().type("triangle-down").size(Math.sqrt(3) * Math.pow(symbolSize / 2, 2))(null);
                };
            }
    ...
    (function (Plottable) {
        var QuantitativeScale = (function (_super) {
            ...
            function QuantitativeScale() {
                _super.call(this);
                this._tickGenerator = function (scale) {
                    return scale.defaultTicks();
                };
            ...
            QuantitativeScale.prototype.extentOfValues = function (values) {
                ...
                var extent = d3.extent(values.filter(function (value) {
                    return Plottable.Utils.Math.isValidNumber(+value);
                }));
            ...
            QuantitativeScale.prototype._setDomain = function (values) {
                var isNaNOrInfinity = function (x) {
                    return Plottable.Utils.Math.isNaN(x) || x === Infinity || x === -Infinity;
                };
        ...
        (function (Scales) {
            var ModifiedLog = (function (_super) {
                ...
                ModifiedLog.prototype.ticks = function () {
                    ...
                    var negativeLogTicks = this._logTicks(-negativeUpper, -negativeLower).map(function (x) {
                        return -x;
                    }).reverse();
                ...
                ModifiedLog.prototype._logTicks = function (lower, upper) {
                    ...
                    var clusters = bases.map(function (b) {
                        return uniqMultiples.map(function (x) {
                            return Math.pow(_this._base, b - 1) * x;
                        });
                    });
            ...
            (function (TickGenerators) {
                ...
                function intervalTickGenerator(interval) {
                    ...
                    return function (s) {
                        ...
                        var middleTicks = Plottable.Utils.Math.range(0, numTicks).map(function (t) {
                            return firstTick + t * interval;
                        });
                ...
                function integerTickGenerator() {
                    return function (s) {
                        ...
                        return defaultTicks.filter(function (tick, i) {
                            return (tick % 1 === 0) || (i === 0) || (i === defaultTicks.length - 1);
                        });
                    };
                }
        ...
        var Drawer = (function () {
                ...
                Object.keys(attrToProjector).forEach(function (attr) {
                    modifiedAttrToProjector[attr] =
                        function (datum, index) {
                            return attrToProjector[attr](datum, index, _this._dataset);
                        };
                });
            ...
            Drawer.prototype.draw = function (data, drawSteps) {
                ...
                appliedDrawSteps.forEach(function (drawStep, i) {
                    Plottable.Utils.Window.setTimeout(function () {
                        return _this._drawStep(drawStep);
                    }, delay);
                    delay += drawStep.animator.totalTime(data.length);
                });
                return this;
    ...
    (function (Plottable) {
        ...
        var ComponentContainer = (function (_super) {
            ...
            function ComponentContainer() {
                var _this = this;
                _super.call(this);
                this._detachCallback = function (component) {
                    return _this.remove(component);
                };
            }
            ...
            ComponentContainer.prototype.anchor = function (selection) {
                ...
                this._forEach(function (c) {
                    return c.anchor(_this.content());
                });
                return this;
            };
            ...
            var Group = (function (_super) {
                ...
                Group.prototype.requestedSpace = function (offeredWidth, offeredHeight) {
                    var requests = this._components.map(function (c) {
                        return c.requestedSpace(offeredWidth, offeredHeight);
                    });
                    return {
                        minWidth: Plottable.Utils.Math.max(requests, function (request) {
                            return request.minWidth;
                        }, 0),
                        minHeight: Plottable.Utils.Math.max(requests, function (request) {
                            return request.minHeight;
                        }, 0)
                    };
                };
    ...
    (function (Plottable) {
        var Axis = (function (_super) {
            ...
            function Axis(scale, orientation) {
                ...
                this._rescaleCallback = function (scale) {
            ...
            Axis.prototype._drawAnnotations = function () {
                ...
                var visibilityF = function (d) {
                    return hiddenAnnotations.has(d) ? "hidden" : "visible";
                };
                ...
                bindElements(this._annotationContainer.select(".annotation-rect-container"), "rect", Axis.ANNOTATION_RECT_CLASS)
                    .attr({
                        ...
                        width: isHorizontal ? function (d) {
                            return measurements.get(d).width;
                        } : function (d) {
                            return measurements.get(d).height;
                        },
                        height: isHorizontal ? function (d) {
                            return measurements.get(d).height;
                        } : function (d) {
                            return measurements.get(d).width;
                        },
            ...
            Axis.prototype._annotationToTier = function (measurements) {
                ...
                this._annotatedTicksToRender().forEach(function (annotatedTick) {
                    ...
                    var tierHasCollision = function (testTier) {
                        return annotationTiers[testTier].some(function (testTick) {
            ...
            var Time = (function (_super) {
                ...
                Time.prototype.tierLabelPositions = function (newPositions) {
                    if (newPositions == null) {
                        ...
                        if (!newPositions.every(function (pos) {
                                return pos.toLowerCase() === "between" || pos.toLowerCase() === "center";
                            })) {
                ...
                Time.prototype.axisConfigurations = function (configurations) {
                    ...
                    this._numTiers = Plottable.Utils.Math.max(this._possibleTimeAxisConfigurations.map(function (config) {
                ...
                Time.prototype._getTickValues = function () {
                    var _this = this;
                    return this._possibleTimeAxisConfigurations[this._mostPreciseConfigIndex].reduce(function (ticks, config) {
                        return ticks.concat(_this._getTickIntervalValues(config));
                    }, []);
                };
                ...
                Time.prototype._getTickValuesForConfiguration = function (config) {
                    ...
                    var tickPosValues = tickPos.map(function (d) {
                        return d.valueOf();
                    }); // can't indexOf with objects
                ...
                Time.prototype._renderTierLabels = function (container, config, index) {
                    ...
                    var tickLabels = container.selectAll("." + Plottable.Axis.TICK_LABEL_CLASS).data(labelPos, function (d) {
                ...
                Time.prototype._renderTickMarks = function (tickValues, index) {
                    ...
                    var offset = this._tierHeights.slice(0, index).reduce(function (translate, height) {
                ...
                Time.prototype._hideOverlappingAndCutOffLabels = function (index) {
                    ...
                    var visibleTickMarkRects = visibleTickMarks[0].map(function (mark) {
        ...
        (function (Axes) {
            var Numeric = (function (_super) {
                ...
                Numeric.prototype._getTickValues = function () {
                    ...
                    if (min === domain[0]) {
                        return scale.ticks().filter(function (i) {
                            return i >= min && i <= max;
                        });
                    }
                    else {
                ...
                Numeric.prototype._hideTickMarksWithoutLabel = function () {
                    ...
                    visibleTickLabels.each(function (labelNumber) {
                        return labelNumbersShown.push(labelNumber);
                    });
                ...
                Numeric.prototype._hideOverlappingTickLabels = function () {
                    ...
                    var visibleTickLabelRects = visibleTickLabels[0].map(function (label) {
        ...
        (function (Axes) {
            var Category = (function (_super) {
                ...
                Category.prototype._measureTicks = function (axisWidth, axisHeight, scale, ticks) {
                    ...
                    var usedWidth = widthFn(wrappingResults, function (t) {
                        return _this._measurer.measure(t.wrappedText).width;
                    }, 0);
                    var usedHeight = heightFn(wrappingResults, function (t) {
                        return _this._measurer.measure(t.wrappedText).height;
                    }, 0);
                ...
                Category.prototype.renderImmediately = function () {
                    ...
                    var tickLabels = this._tickLabelContainer.selectAll("." + Plottable.Axis.TICK_LABEL_CLASS).data(this._scale.domain(), function (d) {
                        return d;
                    });
        ...
        (function (Components) {
            var Legend = (function (_super) {
                ...
                function Legend(colorScale) {
                    ...
                    this._redrawCallback = function (scale) {
                        return _this.redraw();
                    };
                    ...
                    this.comparator(function (a, b) {
                        var formattedText = _this._colorScale.domain().slice().map(function (d) {
                            return _this._formatter(d);
                        });
                        return formattedText.indexOf(a) - formattedText.indexOf(b);
                    });
                    this._symbolFactoryAccessor = function () {
                        return Plottable.SymbolFactories.circle();
                    };
                    this._symbolOpacityAccessor = function () {
                        return 1;
                    };
                }
                ...
                Legend.prototype._calculateLayoutInfo = function (availableWidth, availableHeight) {
                    ...
                    var entryNames = this._colorScale.domain().slice().sort(function (a, b) {
                        return _this._comparator(_this._formatter(a), _this._formatter(b));
                    });
                ...
                Legend.prototype.requestedSpace = function (offeredWidth, offeredHeight) {
                    ...
                    var untruncatedRowLengths = estimatedLayout.rows.map(function (row) {
                        return d3.sum(row, function (entry) {
                            return estimatedLayout.untruncatedEntryLengths.get(entry);
                        });
                    });
                ...
                Legend.prototype.renderImmediately = function () {
                    ...
                    rows.attr("transform", function (d, i) {
                        return "translate(0, " + (i * layout.textHeight + _this._padding) + ")";
                    });
                    var entries = rows.selectAll("g." + Legend.LEGEND_ENTRY_CLASS).data(function (d) {
                        return d;
                    });
                    ...
                    entries.select("path").attr("d", function (d, i, j) {
                        return _this.symbol()(d, j)(layout.textHeight * 0.6);
                    })
                        .attr("transform", "translate(" + (layout.textHeight / 2) + "," + layout.textHeight / 2 + ")")
                        .attr("fill", function (value) {
                            return _this._colorScale.scale(value);
                        })
                        .attr("opacity", function (d, i, j) {
                            return _this.symbolOpacity()(d, j);
                        })
        ...
        (function (Components) {
            var InterpolatedColorLegend = (function (_super) {
                ...
                InterpolatedColorLegend.prototype._generateTicks = function (numSwatches) {
                    if (numSwatches === void 0) {
                        numSwatches = InterpolatedColorLegend._DEFAULT_NUM_SWATCHES;
                    }
                    var domain = this._scale.domain();
                    if (numSwatches === 1) {
                        return [domain[0]];
                ...
                InterpolatedColorLegend.prototype.requestedSpace = function (offeredWidth, offeredHeight) {
                    ...
                    var domain = this._scale.domain();
                    var labelWidths = domain.map(function (d) {
                        return _this._measurer.measure(_this._formatter(d)).width;
                    });
                    var desiredHeight;
                    var desiredWidth;
                ...
                InterpolatedColorLegend.prototype.renderImmediately = function () {
                    ...
                    if (this._isVertical()) {
                        ...
                        swatchHeight = 1;
                        swatchY = function (d, i) {
                            return _this.height() - (i + 1);
                        };
                        ...
                        if (this._orientation === "left") {
                            swatchX = function (d, i) {
                                return textPadding + longestTextWidth + textPadding;
                            };
                        ...
                        swatchX = function (d, i) {
                            return Math.floor(text0Width + 2 * textPadding) + i;
                        };
                        swatchY = function (d, i) {
                            return padding;
                        };
                ...
                Gridlines.prototype._redrawXLines = function () {
                    ...
                    if (this._xScale) {
                        ...
                        var getScaledXValue = function (tickVal) {
                            return _this._xScale.scale(tickVal);
                        };
                ...
                Gridlines.prototype._redrawYLines = function () {
                    ...
                    if (this._yScale) {
                        ...
                        var getScaledYValue = function (tickVal) {
                            return _this._yScale.scale(tickVal);
                        };
        ...
        (function (Components) {
            var Table = (function (_super) {
                ...
                Table.prototype._iterateLayout = function (availableWidth, availableHeight, isFinalOffer) {
                    ...
                    var rowWeights = Table._calcComponentWeights(this._rowWeights, rows, function (c) {
                        return (c == null) || c.fixedHeight();
                    });
                    var colWeights = Table._calcComponentWeights(this._columnWeights, cols, function (c) {
                        return (c == null) || c.fixedWidth();
                    });
                    ...
                    while (true) {
                        ...
                        wantsWidth = guarantees.wantsWidthArr.some(function (x) {
                            return x;
                        });
                        wantsHeight = guarantees.wantsHeightArr.some(function (x) {
                            return x;
                        });
                        ...
                        row.forEach(function (component, colIndex) {
                            ...
                            if (component != null) {
                                component.computeLayout({
                                    x: childXOrigin,
                                    y: childYOrigin
                                }, colWidths[colIndex], rowHeights[rowIndex]);
                            }
                ...
                Table.prototype.fixedWidth = function () {
                    var cols = d3.transpose(this._rows);
                    return Table._fixedSpace(cols, function (c) {
                        return (c == null) || c.fixedWidth();
                    });
                };
                Table.prototype.fixedHeight = function () {
                    return Table._fixedSpace(this._rows, function (c) {
                        return (c == null) || c.fixedHeight();
                    });
                };
    ...
    (function (Plottable) {
        var Plot = (function (_super) {
            ...
            function Plot() {
                ...
                this._includedValuesProvider = function (scale) {
                    return _this._includedValuesForScale(scale);
                };
                this._renderCallback = function (scale) {
                    return _this.render();
                };
                this._onDatasetUpdateCallback = function () {
            ...
            Plot.prototype._setup = function () {
                ...
                this.datasets().forEach(function (dataset) {
                    return _this._createNodesForDataset(dataset);
                });
            };
            Plot.prototype.destroy = function () {
                var _this = this;
                _super.prototype.destroy.call(this);
                this._scales().forEach(function (scale) {
                    return scale.offUpdate(_this._renderCallback);
                });
                this.datasets([]);
            };
            ...
            Plot.prototype._generateAttrToProjector = function () {
                ...
                this._attrBindings.forEach(function (attr, binding) {
                    ...
                    var fn = scale ? function (d, i, dataset) {
                        return scale.scale(accessor(d, i, dataset));
                    } : accessor;
                    h[attr] = fn;
                });
            ...
            Plot.prototype._updateExtents = function () {
                ...
                this._attrBindings.forEach(function (attr) {
                    return _this._updateExtentsForAttr(attr);
                });
                this._propertyExtents.forEach(function (property) {
                    return _this._updateExtentsForProperty(property);
                });
                this._scales().forEach(function (scale) {
                    return scale.addIncludedValuesProvider(_this._includedValuesProvider);
                });
            };
            ...
            Plot.prototype._updateExtentsForKey = function (key, bindings, extents, filter) {
                ...
                extents.set(key, this.datasets().map(function (dataset) {
            ...
            Plot.prototype._computeExtent = function (dataset, accScaleBinding, filter) {
                ...
                if (filter != null) {
                    data = data.filter(function (d, i) {
                        return filter(d, i, dataset);
                    });
                }
                var appliedAccessor = function (d, i) {
                    return accessor(d, i, dataset);
                };
            ...
            Plot.prototype.datasets = function (datasets) {
                var _this = this;
                var currentDatasets = [];
                this._datasetToDrawer.forEach(function (drawer, dataset) {
                    return currentDatasets.push(dataset);
                });
                if (datasets == null) {
                    return currentDatasets;
                }
                currentDatasets.forEach(function (dataset) {
                    return _this._removeDataset(dataset);
                });
                datasets.forEach(function (dataset) {
                    return _this._addDataset(dataset);
                });
                this._onDatasetUpdate();
                return this;
            };
            Plot.prototype._getDrawersInOrder = function () {
                ...
                return this.datasets().map(function (dataset) {
                    return _this._datasetToDrawer.get(dataset);
                });
            };
            ...
            Plot.prototype._getDataToDraw = function () {
                ...
                this.datasets().forEach(function (dataset) {
                    return dataToDraw.set(dataset, dataset.data());
                });
                return dataToDraw;
            };
            Plot.prototype._paint = function () {
                ...
                var times = this.datasets().map(function (ds, i) {
                    return drawers[i].totalDrawTime(dataToDraw.get(ds), drawSteps);
                });
            ...
            Plot.prototype.entities = function (datasets) {
                ...
                return this._lightweightEntities(datasets).map(function (entity) {
                    return _this._lightweightPlotEntityToPlotEntity(entity);
                });
            };
            ...
            Plot._scaledAccessor = function (binding) {
                return binding.scale == null ?
                    binding.accessor :
                    function (d, i, ds) {
                        return binding.scale.scale(binding.accessor(d, i, ds));
                    };
            };
            ...
            var Pie = (function (_super) {
                ...
                function Pie() {
                    ...
                    this.outerRadius(function () {
                        return Math.min(_this.width(), _this.height()) / 2;
                    });
                    this.addClass("pie-plot");
                    this.attr("fill", function (d, i) {
                        return String(i);
                    }, new Plottable.Scales.Color());
                ...
                Pie.prototype._setup = function () {
                    var _this = this;
                    _super.prototype._setup.call(this);
                    this._strokeDrawers.forEach(function (d) {
                        return d.renderArea(_this._renderArea.append("g"));
                    });
                };
                ...
                Pie.prototype._updatePieAngles = function () {
                    ...
                    var pie = d3.layout.pie().sort(null).value(function (d, i) {
                        return sectorValueAccessor(d, i, dataset);
                    })(data);
                    this._startAngles = pie.map(function (slice) {
                        return slice.startAngle;
                    });
                    this._endAngles = pie.map(function (slice) {
                ...
                Pie.prototype._getDataToDraw = function () {
                    ...
                    var filteredData = data.filter(function (d, i) {
                        return Pie._isValidData(sectorValueAccessor(d, i, ds));
                    });
                ...
                Pie.prototype._additionalPaint = function (time) {
                    ...
                    if (this._labelsEnabled) {
                        Plottable.Utils.Window.setTimeout(function () {
                            return _this._drawLabels();
                        }, time);
                    }
                    var drawSteps = this._generateStrokeDrawSteps();
                    var dataToDraw = this._getDataToDraw();
                    this.datasets().forEach(function (dataset) {
                        return _this._strokeDrawers.get(dataset).draw(dataToDraw.get(dataset), drawSteps);
                    });
                };
                ...
                Pie.prototype._drawLabels = function () {
                    ...
                    data.forEach(function (datum, datumIndex) {
                        ...
                        if (showLabel) {
                            var sliceIndices = corners.map(function (corner) {
                                return _this._sliceIndexForPoint(corner);
                            });
                            showLabel = sliceIndices.every(function (index) {
        ...
        var XYPlot = (function (_super) {
            ...
            function XYPlot() {
                ...
                this._adjustYDomainOnChangeFromXCallback = function (scale) {
                    return _this._adjustYDomainOnChangeFromX();
                };
                this._adjustXDomainOnChangeFromYCallback = function (scale) {
                    return _this._adjustXDomainOnChangeFromY();
                };
                var _deltaX = 0;
                var _deltaY = 0;
                var _scalingX = 1;
            ...
            XYPlot.prototype._getDataToDraw = function () {
                ...
                this.datasets().forEach(function (dataset) {
                    dataToDraw.set(dataset, dataToDraw.get(dataset).filter(function (d, i) {
                        return definedFunction(d, i, dataset);
                    }));
                });
                return dataToDraw;
            };
            ...
            var Rectangle = (function (_super) {
                ...
                Rectangle.prototype._generateAttrToProjector = function () {
                    ...
                    if (x2Attr != null) {
                        attrToProjector["width"] = function (d, i, dataset) {
                            return Math.abs(x2Attr(d, i, dataset) - xAttr(d, i, dataset));
                        };
                        ...
                        attrToProjector["width"] = function (d, i, dataset) {
                            return _this._rectangleWidth(xScale);
                        };
                        attrToProjector["x"] = function (d, i, dataset) {
                    ...
                    if (y2Attr != null) {
                        attrToProjector["height"] = function (d, i, dataset) {
                            return Math.abs(y2Attr(d, i, dataset) - yAttr(d, i, dataset));
                        };
                        ...
                        attrToProjector["height"] = function (d, i, dataset) {
                            return _this._rectangleWidth(yScale);
                        };
                        attrToProjector["y"] = function (d, i, dataset) {
                ...
                Rectangle.prototype._generateDrawSteps = function () {
                    return [{
                        ...
                        animator: this._getAnimator("rectangles")
                    }];
                };
                    ...
                    if (scale instanceof Plottable.Scales.Category) {
                        ...
                        var accessorData = d3.set(Plottable.Utils.Array.flatten(this.datasets().map(function (dataset) {
                            return dataset.data().map(function (d, i) {
                                return accessor(d, i, dataset).valueOf();
                            });
                ...
                Rectangle.prototype._getDataToDraw = function () {
                    ...
                    this.datasets().forEach(function (dataset) {
                        var data = dataset.data().filter(function (d, i) {
                            return Plottable.Utils.Math.isValidNumber(attrToProjector["x"](d, i, dataset)) &&
                ...
                Rectangle.prototype._drawLabels = function () {
                    ...
                    this.datasets().forEach(function (dataset, i) {
                        return _this._drawLabel(dataToDraw, dataset, i);
                    });
                };
            ...
            var Scatter = (function (_super) {
                ...
                Scatter.prototype._generateDrawSteps = function () {
                    ...
                    if (this._animateOnNextRender()) {
                        ...
                        resetAttrToProjector["d"] = function () {
                            return "";
                        };
                        drawSteps.push({
                            attrToProjector: resetAttrToProjector,
                            animator: this._getAnimator(Plots.Animator.RESET)
                        });
                    }
                    drawSteps.push({
                        attrToProjector: this._generateAttrToProjector(),
            ...
            var Bar = (function (_super) {
                ...
                function Bar(orientation) {
                    ...
                    if (orientation === void 0) {
                        orientation = Bar.ORIENTATION_VERTICAL;
                    }
                    _super.call(this);
                    this._labelFormatter = Plottable.Formatters.identity();
                    this._labelsEnabled = false;
                    ...
                    this.attr("width", function () {
                        return _this._barPixelWidth;
                    });
                    this._labelConfig = new Plottable.Utils.Map();
                    this._baselineValueProvider = function () {
                        return [_this.baselineValue()];
                    };
                    this._updateBarPixelWidthCallback = function () {
                        return _this._updateBarPixelWidth();
                    };
                }
                ...
                Bar.prototype._additionalPaint = function (time) {
                    ...
                    this.datasets().forEach(function (dataset) {
                        return _this._labelConfig.get(dataset).labelArea.selectAll("g").remove();
                    });
                    if (this._labelsEnabled) {
                        Plottable.Utils.Window.setTimeout(function () {
                            return _this._drawLabels();
                ...
                Bar.prototype._drawLabels = function () {
                    ...
                    this.datasets().forEach(function (dataset) {
                        return labelsTooWide = labelsTooWide || _this._drawLabel(dataToDraw.get(dataset), dataset);
                    });
                ...
                Bar.prototype._drawLabel = function (data, dataset) {
                    ...
                    return labelTooWide.some(function (d) {
                        return d;
                    });
                };
                ...
                Bar.prototype._getBarPixelWidth = function () {
                    ...
                    if (barScale instanceof Plottable.Scales.Category) {
                        ...
                        var numberBarAccessorData = d3.set(Plottable.Utils.Array.flatten(this.datasets().map(function (dataset) {
                            return dataset.data().map(function (d, i) {
                                return barAccessor(d, i, dataset);
                            })
                                .filter(function (d) {
                                    return d != null;
                                })
                        ...
                        numberBarAccessorData.sort(function (a, b) {
                            return a - b;
                        });
                        var scaledData = numberBarAccessorData.map(function (datum) {
                            return barScale.scale(datum);
                        });
            ...
            var Line = (function (_super) {
                ...
                Line.prototype._extentsForProperty = function (property) {
                    ...
                    if (this.autorangeMode() === "y") {
                        includedValues = edgeIntersectionPoints.left.concat(edgeIntersectionPoints.right).map(function (point) {
                            return point.y;
                        });
                    }
                    else {
                        includedValues = edgeIntersectionPoints.top.concat(edgeIntersectionPoints.bottom).map(function (point) {
                            return point.x;
                        });
                    }
                    return extents.map(function (extent) {
                        return d3.extent(d3.merge([extent, includedValues]));
                    });
                };
                ...
                Line.prototype._constructLineProjector = function (xProjector, yProjector) {
                    ...
                    return function (datum, index, dataset) {
                        return d3.svg.line()
                            .x(function (innerDatum, innerIndex) {
                                return xProjector(innerDatum, innerIndex, dataset);
                            })
                            .y(function (innerDatum, innerIndex) {
                                return yProjector(innerDatum, innerIndex, dataset);
                            })
                            .interpolate(_this.interpolator())
                            .defined(function (innerDatum, innerIndex) {
                                return definedProjector(innerDatum, innerIndex, dataset);
                            })(datum);
                    };
                };
                Line.prototype._getDataToDraw = function () {
                    ...
                    this.datasets().forEach(function (dataset) {
                        ...
                        var filteredDataIndices = data.map(function (d, i) {
                            return i;
                        });
                        ...
                        dataToDraw.set(dataset, [filteredDataIndices.map(function (d, i) {
                            return data[d];
                        })]);
                    });
                    return dataToDraw;
        ...
        (function (Plots) {
            var Area = (function (_super) {
                ...
                Area.prototype._setup = function () {
                    var _this = this;
                    _super.prototype._setup.call(this);
                    this._lineDrawers.forEach(function (d) {
                        return d.renderArea(_this._renderArea.append("g"));
                    });
                };
                ...
                Area.prototype._additionalPaint = function () {
                    ...
                    var dataToDraw = this._getDataToDraw();
                    this.datasets().forEach(function (dataset) {
                        return _this._lineDrawers.get(dataset).draw(dataToDraw.get(dataset), drawSteps);
                    });
                };
                ...
                Area.prototype._updateYScale = function () {
                    ...
                    if (constantBaseline != null) {
                        this._constantBaselineValueProvider = function () {
                ...
                Area.prototype.selections = function (datasets) {
                    ...
                    var allSelections = _super.prototype.selections.call(this, datasets)[0];
                    var lineDrawers = datasets.map(function (dataset) {
                        return _this._lineDrawers.get(dataset);
                    })
                        .filter(function (drawer) {
                            return drawer != null;
                        });
                    lineDrawers.forEach(function (ld, i) {
                        return allSelections.push(ld.selectionForIndex(i).node());
                    });
                    return d3.selectAll(allSelections);
                };
                Area.prototype._constructAreaProjector = function (xProjector, yProjector, y0Projector) {
                    ...
                    return function (datum, index, dataset) {
                        var areaGenerator = d3.svg.area()
                            ...
                            .y1(function (innerDatum, innerIndex) {
                                return yProjector(innerDatum, innerIndex, dataset);
                            })
                            .y0(function (innerDatum, innerIndex) {
                                return y0Projector(innerDatum, innerIndex, dataset);
                            })
                            .interpolate(_this.interpolator())
                            .defined(function (innerDatum, innerIndex) {
                                return definedProjector(innerDatum, innerIndex, dataset);
        ...
        (function (Plots) {
            var ClusteredBar = (function (_super) {
                ...
                function ClusteredBar(orientation) {
                    if (orientation === void 0) {
                        orientation = Plots.Bar.ORIENTATION_VERTICAL;
                    }
                ...
                ClusteredBar.prototype._generateAttrToProjector = function () {
                    ...
                    attrToProjector["x"] = this._isVertical ?
                        function (d, i, ds) {
                            return xAttr(d, i, ds) + _this._clusterOffsets.get(ds);
                        } :
                        function (d, i, ds) {
                            return xAttr(d, i, ds);
                        };
                    attrToProjector["y"] = this._isVertical ?
                        ...
                        function (d, i, ds) {
                            return yAttr(d, i, ds) + _this._clusterOffsets.get(ds);
                        };
                    return attrToProjector;
                };
                ClusteredBar.prototype._updateClusterPosition = function () {
                    ...
                    this.datasets().forEach(function (d, i) {
                        return _this._clusterOffsets.set(d, innerScale.scale(String(i)) - innerScale.rangeBand() / 2);
                    });
                };
                ClusteredBar.prototype._makeInnerScale = function () {
                    var innerScale = new Plottable.Scales.Category();
                    innerScale.domain(this.datasets().map(function (d, i) {
                        return String(i);
                    }));
            ...
            var StackedArea = (function (_super) {
                ...
                StackedArea.prototype._checkSameDomain = function (datasets, keyAccessor) {
                    var keySets = datasets.map(function (dataset) {
                        return d3.set(dataset.data().map(function (datum, i) {
                            return keyAccessor(datum, i, dataset).toString();
                        })).values();
                    });
                    var domainKeys = StackedArea._domainKeys(datasets, keyAccessor);
                    if (keySets.some(function (keySet) {
                            return keySet.length !== domainKeys.length;
                        })) {
            ...
            var Easing = (function () {
                ...
                Easing.prototype.animate = function (selection, attrToAppliedProjector) {
                    ...
                    return selection.transition()
                        ...
                        .delay(function (d, i) {
                            return _this.startDelay() + adjustedIterativeDelay * i;
                        })
        ...
        (function (Dispatchers) {
            var Mouse = (function (_super) {
                ...
                function Mouse(svg) {
                    ...
                    var processMoveCallback = function (e) {
                        return _this._measureAndDispatch(e, Mouse._MOUSEMOVE_EVENT_NAME, "page");
                    };
                    ...
                    this._eventToProcessingFunction[Mouse._MOUSEDOWN_EVENT_NAME] =
                        function (e) {
                            return _this._measureAndDispatch(e, Mouse._MOUSEDOWN_EVENT_NAME);
                        };
                    this._eventToProcessingFunction[Mouse._MOUSEUP_EVENT_NAME] =
                        function (e) {
                            return _this._measureAndDispatch(e, Mouse._MOUSEUP_EVENT_NAME, "page");
                        };
                    this._eventToProcessingFunction[Mouse._WHEEL_EVENT_NAME] =
                        function (e) {
                            return _this._measureAndDispatch(e, Mouse._WHEEL_EVENT_NAME);
                        };
                    this._eventToProcessingFunction[Mouse._DBLCLICK_EVENT_NAME] =
                        function (e) {
                            return _this._measureAndDispatch(e, Mouse._DBLCLICK_EVENT_NAME);
                        };
                }
            ...
            var Touch = (function (_super) {
                ...
                function Touch(svg) {
                    ...
                    this._eventToProcessingFunction[Touch._TOUCHSTART_EVENT_NAME] =
                        function (e) {
                            return _this._measureAndDispatch(e, Touch._TOUCHSTART_EVENT_NAME, "page");
                        };
                    this._eventToProcessingFunction[Touch._TOUCHMOVE_EVENT_NAME] =
                        function (e) {
                            return _this._measureAndDispatch(e, Touch._TOUCHMOVE_EVENT_NAME, "page");
                        };
                    this._eventToProcessingFunction[Touch._TOUCHEND_EVENT_NAME] =
                        function (e) {
                            return _this._measureAndDispatch(e, Touch._TOUCHEND_EVENT_NAME, "page");
                        };
                    this._eventToProcessingFunction[Touch._TOUCHCANCEL_EVENT_NAME] =
                        function (e) {
                            return _this._measureAndDispatch(e, Touch._TOUCHCANCEL_EVENT_NAME, "page");
                        };
                }
        ...
        (function (Dispatchers) {
            var Key = (function (_super) {
                ...
                function Key() {
                    var _this = this;
                    _super.call(this);
                    this._eventToProcessingFunction[Key._KEYDOWN_EVENT_NAME] = function (e) {
                        return _this._processKeydown(e);
                    };
                    this._eventToProcessingFunction[Key._KEYUP_EVENT_NAME] = function (e) {
                        return _this._processKeyup(e);
                    };
                }
    ...
    (function (Plottable) {
        var Interaction = (function () {
            function Interaction() {
                var _this = this;
                this._anchorCallback = function (component) {
                    return _this._anchor(component);
                };
                this._enabled = true;
            }
        ...
        (function (Interactions) {
            var Click = (function (_super) {
                ...
                function Click() {
                    ...
                    this._mouseDownCallback = function (p) {
                        return _this._handleClickDown(p);
                    };
                    this._mouseUpCallback = function (p) {
                        return _this._handleClickUp(p);
                    };
                    this._touchStartCallback = function (ids, idToPoint) {
                        return _this._handleClickDown(idToPoint[ids[0]]);
                    };
                    this._touchEndCallback = function (ids, idToPoint) {
                        return _this._handleClickUp(idToPoint[ids[0]]);
                    };
                    this._touchCancelCallback = function (ids, idToPoint) {
                        return _this._clickedDown = false;
                    };
                }
        ...
        (function (Interactions) {
            ...
            var DoubleClick = (function (_super) {
                ...
                function DoubleClick() {
                    ...
                    this._dblClickCallback = function (p) {
                        return _this._handleDblClick();
                    };
                    this._touchStartCallback = function (ids, idToPoint) {
                        return _this._handleClickDown(idToPoint[ids[0]]);
                    };
                    ...
                    this._touchCancelCallback = function (ids, idToPoint) {
                        return _this._handleClickCancel();
                    };
                }
        ...
        (function (Interactions) {
            var Key = (function (_super) {
                ...
                function Key() {
                    ...
                    this._mouseMoveCallback = function (point) {
                        return false;
                    }; // HACKHACK: registering a listener
                    this._downedKeys = new Plottable.Utils.Set();
                    this._keyDownCallback = function (keyCode, event) {
                        return _this._handleKeyDownEvent(keyCode, event);
                    };
                    this._keyUpCallback = function (keyCode) {
                        return _this._handleKeyUpEvent(keyCode);
                    };
                }
        ...
        (function (Interactions) {
            var Pointer = (function (_super) {
                ...
                function Pointer() {
                    ...
                    this._mouseMoveCallback = function (p, e) {
                        return _this._handleMouseEvent(p, e);
                    };
                    this._touchStartCallback = function (ids, idToPoint, e) {
                        return _this._handleTouchEvent(idToPoint[ids[0]], e);
                    };
                }
        ...
        (function (Interactions) {
            var PanZoom = (function (_super) {
                ...
                function PanZoom(xScale, yScale) {
                    var _this = this;
                    _super.call(this);
                    this._wheelCallback = function (p, e) {
                        return _this._handleWheelEvent(p, e);
                    };
                    this._touchStartCallback = function (ids, idToPoint, e) {
                        return _this._handleTouchStart(ids, idToPoint, e);
                    };
                    this._touchMoveCallback = function (ids, idToPoint, e) {
                        return _this._handlePinch(ids, idToPoint, e);
                    };
                    this._touchEndCallback = function (ids, idToPoint, e) {
                        return _this._handleTouchEnd(ids, idToPoint, e);
                    };
                    this._touchCancelCallback = function (ids, idToPoint, e) {
                        return _this._handleTouchEnd(ids, idToPoint, e);
                    };
                ...
                PanZoom.prototype._handlePinch = function (ids, idToPoint, e) {
                    ...
                    var normalizedPointDiffs = points.map(function (point, i) {
                        return {
                            x: (point.x - oldPoints[i].x) / magnifyAmount,
                            y: (point.y - oldPoints[i].y) / magnifyAmount
                        };
                    });
                ...
                PanZoom.prototype._magnifyScale = function (scale, magnifyAmount, centerValue) {
                    var magnifyTransform = function (rangeValue) {
                        return scale.invert(centerValue - (centerValue - rangeValue) * magnifyAmount);
                    };
                ...
                PanZoom.prototype._translateScale = function (scale, translateAmount) {
                    var translateTransform = function (rangeValue) {
                        return scale.invert(rangeValue + translateAmount);
                    };
                ...
                PanZoom.prototype._setupDragInteraction = function () {
                    ...
                    var lastDragPoint;
                    this._dragInteraction.onDragStart(function () {
        ...
        (function (Interactions) {
            var Drag = (function (_super) {
                ...
                function Drag() {
                    ...
                    this._mouseDownCallback = function (p, e) {
                        return _this._startDrag(p, e);
                    };
                    this._mouseMoveCallback = function (p, e) {
                        return _this._doDrag(p, e);
                    };
                    this._mouseUpCallback = function (p, e) {
                        return _this._endDrag(p, e);
                    };
                    this._touchStartCallback = function (ids, idToPoint, e) {
                        return _this._startDrag(idToPoint[ids[0]], e);
                    };
                    this._touchMoveCallback = function (ids, idToPoint, e) {
                        return _this._doDrag(idToPoint[ids[0]], e);
                    };
                    this._touchEndCallback = function (ids, idToPoint, e) {
                        return _this._endDrag(idToPoint[ids[0]], e);
                    };
                }
            ...
            var DragBoxLayer = (function (_super) {
                ...
                DragBoxLayer.prototype._setup = function () {
                    ...
                    var createLine = function () {
                        return _this._box.append("line").style({
                            "opacity": 0,
                            "stroke": "pink",
                    ...
                    if (this._hasCorners) {
                        var createCorner = function () {
                            return _this._box.append("circle")
                                .style({
                                    "opacity": 0,
                                    "fill": "pink",
                ...
                DragBoxLayer.prototype.destroy = function () {
                    var _this = this;
                    _super.prototype.destroy.call(this);
                    this._dragStartCallbacks.forEach(function (callback) {
                        return _this._dragCallbacks.delete(callback);
                    });
                    this._dragCallbacks.forEach(function (callback) {
                        return _this._dragCallbacks.delete(callback);
                    });
                    this._dragEndCallbacks.forEach(function (callback) {
                        return _this._dragEndCallbacks.delete(callback);
                    });
        ...
        (function (Components) {
            var DragLineLayer = (function (_super) {
                ...
                DragLineLayer.prototype.destroy = function () {
                    ...
                    _super.prototype.destroy.call(this);
                    this._dragStartCallbacks.forEach(function (callback) {
                        return _this._dragStartCallbacks.delete(callback);
                    });
                    this._dragCallbacks.forEach(function (callback) {
                        return _this._dragCallbacks.delete(callback);
                    });
